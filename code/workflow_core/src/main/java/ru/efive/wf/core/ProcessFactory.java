...
public final class ProcessFactory {
    ...
    public static <T extends ProcessedData> Process getProcessByType(T t) {
        ...
        try {
            ...
            if (id != null && !id.equals("")) {
                ...
                if (t.getDocumentType().equals(DocumentType.PaperCopyDocument)) {
                    System.out.println("Initialization process for paper copy document");
                    currentStatus = getCurrentStatusPaperCopyDocument(t, process);
                } else if (t.getDocumentType().equals(DocumentType.IncomingDocument)) {
    ...
    private static <T extends ProcessedData> Status<T> getCurrentStatusPaperCopyDocument(T t, Process process) {
        Map<DocumentStatus, Status<T>> statuses = new HashMap<DocumentStatus, Status<T>>();
        // Проект документа - Зарегистрирован
        Status<T> status = new Status<T>();
        status.setStatus(DocumentStatus.DOC_PROJECT_1);
        ...
        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.IN_ARCHIVE_99);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        status = statuses.get(DocumentStatus.CHECK_IN_2);
        fromStatusActions = statuses.get(DocumentStatus.CHECK_IN_2).getAvailableActions();
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.SEND);
        toStatusAction.setInitialStatus(status);

        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.SEND);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        fromStatusActions = new ArrayList<StatusChangeAction>();
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.RECIVE);
        toStatusAction.setInitialStatus(status);

        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.RECIVE);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        status = statuses.get(DocumentStatus.IN_ARCHIVE_99);
        fromStatusActions = new ArrayList<StatusChangeAction>();
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.OUT_ARCHIVE);
        toStatusAction.setInitialStatus(status);
        ...
        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.OUT_ARCHIVE);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        fromStatusActions = new ArrayList<StatusChangeAction>();
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.RETURN_TO_ARCHIVE);
        toStatusAction.setInitialStatus(status);

        toStatus = statuses.get(DocumentStatus.IN_ARCHIVE_99);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        status = statuses.get(DocumentStatus.IN_ARCHIVE_99);
        fromStatusActions = status.getAvailableActions();
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.DESTROY);
        toStatusAction.setInitialStatus(status);

        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.SOURCE_DESTROY);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
        ...
        toStatusAction = new StatusChangeAction(process);
        toStatusAction.setAction(DocumentAction.REDIRECT_IN_OTHER_ARCHIVE_135);
        toStatusAction.setInitialStatus(status);

        toStatus = new Status<T>();
        toStatus.setStatus(DocumentStatus.REDIRECT);
        toStatus.setProcessedData(t);
        toStatusAction.setDestinationStatus(toStatus);
