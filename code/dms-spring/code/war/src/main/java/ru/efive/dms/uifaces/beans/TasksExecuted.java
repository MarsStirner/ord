...
@SessionScoped
public class TasksExecuted extends AbstractDocumentListHolderBean<Task> {
	...
	protected List<Task> loadDocuments() {
		...
		try {
			...
			list = sessionManagement.getDAO(TaskDAOImpl.class, ApplicationHelper.TASK_DAO).findAllExecutedDocumentsByUser(filter, sessionManagement.getLoggedUser(),
