...
import ru.efive.dms.uifaces.beans.RoleListSelectModalBean;
import ru.efive.dms.uifaces.beans.SessionManagementBean;
import ru.efive.dms.uifaces.beans.UserListSelectModalBean;
import ru.efive.dms.uifaces.beans.UserSelectModalBean;
...
public class RouteTemplateBean extends AbstractDocumentHolderBean<RouteTemplate, Integer> {
	...
	protected boolean deleteDocument() {
		...
		try {
			result = sessionManagement.getDAO(EngineDAOImpl.class, "engineDao").delete(getDocumentId());
			if (!result) {
	...
	protected void initDocument(Integer id) {
		try {
			setDocument(sessionManagement.getDAO(EngineDAOImpl.class, "engineDao").get(RouteTemplate.class, id));
			if (getDocument() == null) {
	...
	protected boolean saveDocument() {
		boolean result = false;
		try {
			RouteTemplate template = sessionManagement.getDAO(EngineDAOImpl.class, "engineDao").save(RouteTemplate.class, getDocument());
			if (template == null) {
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(
	...
	public void addRootHumanTask() {
		...
		humanTask.setDocumentStatus(DocumentStatus.NEW);
