...
public class ContactInfoTypeDaoImpl extends ReferenceBookDaoImpl<RbContactPointSystem> implements ContactInfoTypeDao {
    @Override
    public Class<RbContactPointSystem> getEntityClass() {
        return RbContactPointSystem.class;
    }
}
