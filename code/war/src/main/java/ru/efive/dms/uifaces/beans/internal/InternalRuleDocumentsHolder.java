...
@Named("internal_rules")
@SessionScoped
public class InternalRuleDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {
    private static final String beanName = "internal_positions";
    ...
    static {
        filters.put("formValue", "Правила внутреннего распорядка");
