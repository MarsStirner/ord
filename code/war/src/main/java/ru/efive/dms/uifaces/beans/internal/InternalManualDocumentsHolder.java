...
@Named("internal_manuals")
@SessionScoped
public class InternalManualDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {
    private static final String beanName = "internal_manuals";
    ...
    static {
        filters.put("formValue", "Методическое пособие");
