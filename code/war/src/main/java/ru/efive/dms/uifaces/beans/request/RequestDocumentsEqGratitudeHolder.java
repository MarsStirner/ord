...
@Named("gratitudeRequestDocuments")
@SessionScoped
public class RequestDocumentsEqGratitudeHolder extends AbstractDocumentListHolderBean<RequestDocument> {
    ...
    static {
        ...
        filters.put("formValue", "Благодарность");
    }
