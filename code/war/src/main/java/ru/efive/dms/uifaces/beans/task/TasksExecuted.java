...
public class TasksExecuted extends AbstractDocumentListHolderBean<Task> {
    ...
    protected List<Task> loadDocuments() {
        ...
        try {
            ...
            list = new ArrayList<Task>(new HashSet<Task>(sessionManagement.getDAO(TaskDAOImpl.class, TASK_DAO).findAllExecutedDocumentsByUser(filter, sessionManagement.getLoggedUser(),
