...
@Named("internal_garantees")
@SessionScoped
public class InternalGaranteeDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {

    private static final String beanName = "internal_garantees";
    ...
    static {
        filters.put("formValue", "Гарантийное письмо");
