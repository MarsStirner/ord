...
@Named("internal_orders")
@SessionScoped
public class InternalOrderDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {
    private static final String beanName = "internal_orders";
