...
@Named("claims")
@SessionScoped
public class TasksEqClaimHolder extends AbstractDocumentListHolderBean<Task> {

    /**
     *
     */
    private static final long serialVersionUID = -4773727685308846500L;
    ...
    static {
        filters.put("exerciseTypeValue", "Заявка");
