...
@Named("internal_instructions")
@SessionScoped
public class InternalInstructionDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {
    private static final String beanName = "internal_instructions";
    ...
    static {
        filters.put("formValue", "Инструкция");
