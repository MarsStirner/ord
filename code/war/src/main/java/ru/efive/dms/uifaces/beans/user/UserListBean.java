...
public class UserListBean extends AbstractDocumentListHolderBean<User> {
    ...
    protected int getTotalCount() {
        return new Long(sessionManagement.getDAO(UserDAO.class, ApplicationHelper.USER_DAO).countDocument(false)).intValue();
    }

    //TODO: filtering
    @Override
    protected List<User> loadDocuments() {
        return sessionManagement.getDAO(UserDAO.class, ApplicationHelper.USER_DAO).findDocuments(
