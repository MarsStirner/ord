...
@Named("resolutions")
@SessionScoped
public class TasksEqResolutionHolder extends AbstractDocumentListHolderBean<Task> {

    /**
     *
     */
    private static final long serialVersionUID = -252147711078428139L;
    ...
    static {
        filters.put("formDescription", "resolution");
