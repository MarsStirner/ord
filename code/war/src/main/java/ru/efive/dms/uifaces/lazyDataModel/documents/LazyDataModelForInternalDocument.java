...
public class LazyDataModelForInternalDocument extends AbstractFilterableLazyDataModel<InternalDocument> {
     ...
     */
    public LazyDataModelForInternalDocument(final InternalDocumentDAOImpl dao, final ViewFactDaoImpl viewFactDao, final AuthorizationData authData) {
        this.dao = dao;
    ...
    public List<InternalDocument> load(
        ...
        if (authData != null) {
            ...
            final List<InternalDocument> resultList = dao.getDocumentListByFilters(
                    authData,
                    getFilter(),
                    this.filters,
                    sortField,
