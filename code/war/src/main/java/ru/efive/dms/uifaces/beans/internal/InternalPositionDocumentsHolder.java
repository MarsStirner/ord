...
@Named("internal_positions")
@SessionScoped
public class InternalPositionDocumentsHolder extends AbstractDocumentListHolderBean<InternalDocument> {
    ...
    static {
        filters.put("formValue", "Положение");
