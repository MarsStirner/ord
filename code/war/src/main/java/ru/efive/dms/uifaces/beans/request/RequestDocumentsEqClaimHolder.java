...
@Named("claimRequestDocuments")
@SessionScoped
public class RequestDocumentsEqClaimHolder extends AbstractDocumentListHolderBean<RequestDocument> {
    ...
    static {
        ...
        filters.put("formValue", "Заявка на лечение");
    }
